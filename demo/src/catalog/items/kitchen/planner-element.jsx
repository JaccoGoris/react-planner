...
let steel = textureLoader.load(require('./steel.jpg').default)
let darkSteel = textureLoader.load(require('./darksteel.jpg').default)
let logo = textureLoader.load(require('./logo.jpg').default)
