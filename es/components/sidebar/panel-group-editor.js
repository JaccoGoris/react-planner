...
var PanelGroupEditor = (function (_Component) {
  ...
  function PanelGroupEditor(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        PanelGroupEditor.__proto__ || Object.getPrototypeOf(PanelGroupEditor)
  ...
  _createClass(PanelGroupEditor, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var group = this.props.state.getIn([
          'scene',
          'groups',
          this.props.groupID,
        ])
            ...
            React.createElement(
              ...
              React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(FormTextInput, {
                      ...
                      onChange: function onChange(e) {
                        return _this2.context.groupsActions.setGroupAttributes(
                          _this2.props.groupID,
                ...
                React.createElement(
                  'tr',
                  null,
                  React.createElement('td', { style: firstTdStyle }, 'X'),
                  React.createElement(
                    'td',
                    null,
                    React.createElement(FormNumberInput, {
                      value: group.get('x'),
                      onChange: function onChange(e) {
                        return _this2.context.groupsActions.groupTranslate(
                          _this2.props.groupID,
                          e.target.value,
                          group.get('y')
                        )
                ...
                React.createElement(
                  'tr',
                  null,
                  React.createElement('td', { style: firstTdStyle }, 'Y'),
                  React.createElement(
                    'td',
                    null,
                    React.createElement(FormNumberInput, {
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(FormNumberInput, {
                      ...
                      onChange: function onChange(e) {
                        return _this2.context.groupsActions.groupRotate(
                          _this2.props.groupID,
                          e.target.value
                        )
                      },
                    ...
                    React.createElement(
                      ...
                      elements.entrySeq().map(function (_ref) {
                        ...
                        return layerElements.entrySeq().map(function (_ref3) {
                          ...
                          return ElementList.valueSeq().map(function (
                            elementID
                          ) {
                            var element = _this2.props.state.getIn([
                              'scene',
                              'layers',
                              layerID,
                              elementPrototype,
                            ...
                            return React.createElement(
                              ...
                              React.createElement(
                                ...
                                {
                                  style: iconColStyle,
                                  title: _this2.context.translator.t(
                                    'Un-chain Element from Group'
                                  ),
                                },
                                React.createElement(FaUnlink, {
                                  onClick: function onClick(e) {
                                    return _this2.context.groupsActions.removeFromGroup(
                                      _this2.props.groupID,
                                      layerID,
                                      elementPrototype,
                                      elementID
