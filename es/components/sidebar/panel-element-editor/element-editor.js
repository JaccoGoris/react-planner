      ...
      value: function initAttrData(element, layer, state) {
        ...
        switch (element.prototype) {
          ...
          case 'lines': {
            ...
            var distance = GeometryUtils.pointsDistance(
              v_a.x,
              v_a.y,
              v_b.x,
              v_b.y
          ...
          case 'lines': {
            switch (attributeName) {
              case 'lineLength': {
                ...
                var _GeometryUtils$orderV = GeometryUtils.orderVertices([
                    v_0,
                    v_1,
                  ]),
                ...
                var v_b_new = GeometryUtils.extendLine(
                  v_a.x,
                  v_a.y,
                  v_b.x,
                  v_b.y,
              ...
              case 'vertexTwo': {
                attributesFormData = attributesFormData.withMutations(function (
                  ...
                  var newDistance = GeometryUtils.verticesDistance(
                    attr.get('vertexOne'),
                    attr.get('vertexTwo')
                  )
          ...
          case 'holes': {
            switch (attributeName) {
              case 'offsetA': {
                ...
                var orderedVertices = GeometryUtils.orderVertices([
                ...
                var offset = GeometryUtils.pointPositionOnLineSegment(
                  x0,
                  y0,
                  x1,
                  y1,
                ...
                var endAt = MathUtils.toFixedFloat(
              ...
              case 'offsetB': {
                ...
                var _orderedVertices2 = GeometryUtils.orderVertices([
                ...
                var _alpha = GeometryUtils.angleBetweenTwoPoints(
                  _x,
                  _y,
                  _x2,
                  _y2
                ...
                var _offset = GeometryUtils.pointPositionOnLineSegment(
                  _x,
                  _y,
                  _x2,
                  _y2,
                ...
                var startAt = MathUtils.toFixedFloat(
