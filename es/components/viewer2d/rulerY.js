...
var RulerY = (function (_Component) {
  ...
  function RulerY(props, context) {
    ...
    return _possibleConstructorReturn(
      this,
      (RulerY.__proto__ || Object.getPrototypeOf(RulerY)).call(
        this,
        props,
        context
      )
  ...
  _createClass(RulerY, [
    {
      ...
      value: function render() {
        ...
        var markerStyle = {
          position: 'absolute',
          top:
            this.props.zeroTopPosition -
            this.props.mouseY * this.props.zoom -
            6.5,
          left: 8,
          width: 0,
          height: 0,
        ...
        var positiveRulerContainer = _extends({}, rulerContainer, {
          top:
            this.props.zeroTopPosition -
            this.props.positiveUnitsNumber * elementH,
        ...
        var negativeRulerContainer = _extends({}, rulerContainer, {
          top:
            this.props.zeroTopPosition +
            this.props.negativeUnitsNumber * elementH,
          ...
          for (var _x = 1; _x <= this.props.positiveUnitsNumber; _x++) {
            ...
            positiveDomElements.push(
              React.createElement(
                ...
                React.createElement('div', { style: insideElementsStyle }, val)
              )
            )
          }
        }
