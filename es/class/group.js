        ...
        layerList.entrySeq().forEach(function (_ref3) {
          ...
          if (lines)
            lines.forEach(function (lineID) {
              ...
              var _GeometryUtils$midPoi = GeometryUtils.midPoint(
                  x1,
                  y1,
                  x2,
                  y2
          ...
          if (holes)
            holes.forEach(function (holeID) {
              ...
              var _GeometryUtils$extend = GeometryUtils.extendLine(
                  x1,
                  y1,
                  x2,
                  y2,
          ...
          if (areas)
            areas.forEach(function (areaID) {
              ...
              var _GeometryUtils$vertic = GeometryUtils.verticesMidPoint(
                  areaVertices
                ),
        ...
        layerList.entrySeq().forEach(function (_ref7) {
          ...
          if (lines) {
            ...
            for (var _vertexID in vertices) {
              state = Vertex.beginDraggingVertex(state, groupLayerID, _vertexID)
                .updatedState
        ...
        layerList.entrySeq().forEach(function (_ref9) {
          ...
          if (lines) {
            ...
            for (var vertexID in vertices) {
              ...
              var _GeometryUtils$rotate = GeometryUtils.rotatePointAroundPoint(
                  xV,
                  yV,
                  barX,
                  barY,
          ...
          if (items)
            state = items
              ...
              .reduce(function (newState, item) {
                ...
                var _GeometryUtils$rotate2 = GeometryUtils.rotatePointAroundPoint(
                    xI,
                    yI,
                    barX,
                    barY,
