...
export function updatedWall(element, layer, scene, textures, mesh, oldElement, differences, selfDestroy, selfBuild) {
  ...
  if (differences[0] == 'selected') {
    ...
    if (differences[1] == 'thickness') {
      var _newThickness = element.getIn(['properties', 'thickness', 'length']);
      var _oldThickness = oldElement.getIn(['properties', 'thickness', 'length']);
      var halfNewThickness = _newThickness / 2;
      var texturedFaceDistance = halfNewThickness + 1;
      var _originalThickness = _oldThickness / soul.scale.z;
      ...
      soul.scale.set(1, 1, _newThickness / _originalThickness);
