...
var FormNumberInput = (function (_Component) {
  ...
  function FormNumberInput(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        FormNumberInput.__proto__ || Object.getPrototypeOf(FormNumberInput)
  ...
  _createClass(FormNumberInput, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (this.state.focus)
          numericInputStyle.border =
            '1px solid ' + SharedStyle.SECONDARY_COLOR.main
        ...
        var currValue = regexp.test(this.state.showedValue)
        ...
        var saveFn = function saveFn(e) {
          ...
          if (_this2.state.valid) {
            var savedValue =
              _this2.state.showedValue !== '' &&
              _this2.state.showedValue !== '-'
                ? parseFloat(_this2.state.showedValue)
                : 0
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement('input', {
            ...
            onKeyDown: function onKeyDown(e) {
              ...
              if (
                (keyCode == _constants.KEYBOARD_BUTTON_CODE.ENTER ||
                  keyCode == _constants.KEYBOARD_BUTTON_CODE.TAB) &&
                different
              ) {
                saveFn(e)
              }
