...
var PanelGroups = (function (_Component) {
  ...
  function PanelGroups(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (PanelGroups.__proto__ || Object.getPrototypeOf(PanelGroups)).call(
        this,
        props,
        context
      )
                ...
                _react2.default.createElement(
                  ...
                  groups.entrySeq().map(function (_ref) {
                    ...
                    var swapVisibility = function swapVisibility(e) {
                      e.stopPropagation()
                      _this2.context.groupsActions.setGroupProperties(
                        groupID,
                        new _immutable.Map({ visible: !group.get('visible') })
                      )
                    }
                    ...
                    var dimension = group
                      .get('elements')
                      .reduce(function (sum, layer) {
                        return (
                          sum +
                          layer.reduce(function (lSum, elProt) {
                    ...
                    return _react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(_fa.FaUnlink, {
                          onClick: function onClick(e) {
                            return _this2.context.groupsActions.removeGroup(
                              groupID
                            )
                          },
                          style: !shouldHighlight
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(_fa.FaTrash, {
                          onClick: function onClick(e) {
                            return _this2.context.groupsActions.removeGroupAndDeleteElements(
                              groupID
                            )
                          },
                          style: !shouldHighlight
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'td',
                  {
                    style: !this.state.newEmptyHover
                      ? newLayerLableStyle
                ...
                _react2.default.createElement(
                  'td',
                  {
                    style: !this.state.newSelectedHover
                      ? newLayerLableStyle
                      : newLayerLableHoverStyle,
                    onMouseOver: function onMouseOver() {
