...
var PanelLayerElement = (function (_Component) {
  ...
  function PanelLayerElement(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        PanelLayerElement.__proto__ || Object.getPrototypeOf(PanelLayerElement)
    ...
    },
    {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          _panel2.default,
          {
            name: this.context.translator.t(
              'Elements on layer {0}',
              layer.name
            ),
          },
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'td',
                    null,
                    _react2.default.createElement(_md.MdSearch, {
                      ...
                      return _react2.default.createElement(
                        'div',
                        {
                          ...
                          onClick: function onClick(e) {
                            return _this2.context.linesActions.selectLine(
                              layer.id,
                              line.id
                            )
                          },
                    ...
                    .map(function (_ref3) {
                      ...
                      return _react2.default.createElement(
                        'div',
                        {
                          key: holeID,
                          onClick: function onClick(e) {
                            return _this2.context.holesActions.selectHole(
                              layer.id,
                              hole.id
                            )
                          },
                    ...
                    .map(function (_ref5) {
                      ...
                      return _react2.default.createElement(
                        'div',
                        {
                          key: itemID,
                          onClick: function onClick(e) {
                            return _this2.context.itemsActions.selectItem(
                              layer.id,
                              item.id
                            )
                          },
