...
var _panelMultiElementsEditor2 = _interopRequireDefault(
  _panelMultiElementsEditor
)
  ...
  var sorter = [
    {
      index: 0,
      condition: true,
      dom: _react2.default.createElement(_panelGuides2.default, {
        state: state,
      }),
    },
    {
      index: 1,
      condition: true,
      dom: _react2.default.createElement(_panelLayers2.default, {
        state: state,
      }),
    },
    {
    ...
    },
    {
      ...
      dom: _react2.default.createElement(_panelElementEditor2.default, {
        state: state,
      }),
    },
