...
function Sidebar(_ref) {
  ...
  var sorter = [{ index: 0, condition: true, dom: _react2.default.createElement(_panelGuides2.default, { state: state }) }, { index: 1, condition: true, dom: _react2.default.createElement(_panelLayers2.default, { state: state }) }, {
    index: 2,
    condition: true,
