...
var PanelMultiElementsEditor = (function (_Component) {
  ...
  function PanelMultiElementsEditor(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        PanelMultiElementsEditor.__proto__ ||
        Object.getPrototypeOf(PanelMultiElementsEditor)
  ...
  _createClass(PanelMultiElementsEditor, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (
          ![
            _constants.MODE_IDLE,
            _constants.MODE_2D_ZOOM_IN,
            _constants.MODE_2D_ZOOM_OUT,
            _constants.MODE_2D_PAN,
            _constants.MODE_3D_VIEW,
            _constants.MODE_3D_FIRST_PERSON,
            _constants.MODE_WAITING_DRAWING_LINE,
            _constants.MODE_DRAWING_LINE,
            _constants.MODE_DRAWING_HOLE,
            _constants.MODE_DRAWING_ITEM,
            _constants.MODE_DRAGGING_LINE,
            _constants.MODE_DRAGGING_VERTEX,
            _constants.MODE_DRAGGING_ITEM,
            _constants.MODE_DRAGGING_HOLE,
            _constants.MODE_ROTATING_ITEM,
            _constants.MODE_UPLOADING_IMAGE,
            _constants.MODE_FITTING_IMAGE,
          ].includes(mode)
        )
          return null
        ...
        var selecteds = this.props.state.getIn([
          'scene',
          'layers',
          selectedLayer,
          'selected',
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('p', null, 'Multiselection tab'),
            _react2.default.createElement(
              'table',
              { style: tableStyle },
              _react2.default.createElement(
                    ...
                    'td',
                    {
                      ...
                      onClick: function onClick(e) {
                        ...
                        for (var x = 0; x < selectedJs.lines.length; x++) {
                          _this2.context.groupsActions.addToGroup(
                            _this2.state.selectedGroupID,
                            selectedLayer,
                            'lines',
                            selectedJs.lines[x]
