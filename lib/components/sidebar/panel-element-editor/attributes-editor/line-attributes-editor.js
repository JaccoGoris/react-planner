...
function LineAttributesEditor(_ref, _ref2) {
  ...
  var name = attributeFormData.has('name')
    ? attributeFormData.get('name')
    : element.name
  var vertexOne = attributeFormData.has('vertexOne')
    ? attributeFormData.get('vertexOne')
    : null
  var vertexTwo = attributeFormData.has('vertexTwo')
    ? attributeFormData.get('vertexTwo')
    : null
  var lineLength = attributeFormData.has('lineLength')
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'tr',
          null,
          _react2.default.createElement('td', { style: firstTdStyle }, 'X1'),
          _react2.default.createElement(
            'td',
            null,
            _react2.default.createElement(
              _export.FormNumberInput,
              _extends(
                {
        ...
        _react2.default.createElement(
          'tr',
          null,
          _react2.default.createElement('td', { style: firstTdStyle }, 'Y1'),
          _react2.default.createElement(
            'td',
            null,
            _react2.default.createElement(
        ...
        _react2.default.createElement(
          'tr',
          null,
          _react2.default.createElement('td', { style: firstTdStyle }, 'X2'),
          _react2.default.createElement(
            'td',
            null,
            _react2.default.createElement(
        ...
        _react2.default.createElement(
          'tr',
          null,
          _react2.default.createElement('td', { style: firstTdStyle }, 'Y2'),
          _react2.default.createElement(
            'td',
            null,
            _react2.default.createElement(
