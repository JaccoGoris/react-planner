...
function ItemAttributesEditor(_ref, _ref2) {
  ...
  var name = attributeFormData.has('name')
    ...
    : element.name
  var renderedX = attributeFormData.has('x')
    ? attributeFormData.get('x')
    : element.x
  var renderedY = attributeFormData.has('y')
    ? attributeFormData.get('y')
    : element.y
  var renderedR = attributeFormData.has('rotation')
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'tr',
        null,
        _react2.default.createElement('td', { style: firstTdStyle }, 'X'),
        _react2.default.createElement(
          'td',
          null,
          _react2.default.createElement(
            _formNumberInput2.default,
            _extends(
              {
                value: renderedX,
                onChange: function onChange(event) {
      ...
      _react2.default.createElement(
        'tr',
        null,
        _react2.default.createElement('td', { style: firstTdStyle }, 'Y'),
        _react2.default.createElement(
          'td',
          null,
          _react2.default.createElement(
