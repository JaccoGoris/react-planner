...
var Scene3DViewer = (function (_React$Component) {
  ...
  function Scene3DViewer(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Scene3DViewer.__proto__ || Object.getPrototypeOf(Scene3DViewer)).call(
        this,
        props
      )
    )
  ...
  _createClass(Scene3DViewer, [
    {
      ...
      value: function componentDidMount() {
        ...
        // LOAD DATA
        var planData = (0, _sceneCreator.parseData)(
          data,
          actions,
        ...
        this.mouseUpEvent = function (event) {
          ...
          if (
            Math.abs(mouse.x - _this2.lastMousePosition.x) <= 0.02 &&
            Math.abs(mouse.y - _this2.lastMousePosition.y) <= 0.02
          ) {
        ...
        var orbitController = new _orbitControls2.default(
          camera,
