...
var Viewer3DFirstPerson = (function (_React$Component) {
  ...
  function Viewer3DFirstPerson(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        Viewer3DFirstPerson.__proto__ ||
        Object.getPrototypeOf(Viewer3DFirstPerson)
      ).call(this, props)
    )
  ...
  _createClass(Viewer3DFirstPerson, [
    {
      ...
      value: function componentDidMount() {
        ...
        var canvasWrapper = _reactDom2.default.findDOMNode(
        ...
        var _initPointerLock = (0, _pointerLockNavigation.initPointerLock)(
            camera,
        ...
        var yInitialPosition =
          ...
          (this.planData.boundingBox.min.y - this.planData.boundingBox.max.y) /
            2 +
          humanHeight
        ...
        this.keyDownEvent = function (event) {
          var moveResult = (0, _firstPersonControls.firstPersonOnKeyDown)(
            event,
            moveForward,
            moveLeft,
            moveBackward,
        ...
        this.keyUpEvent = function (event) {
          var moveResult = (0, _firstPersonControls.firstPersonOnKeyUp)(
            event,
            moveForward,
            moveLeft,
            moveBackward,
    ...
    },
    {
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.scene !== this.props.state.scene) {
          var changedValues = (0, _immutablediff2.default)(
            this.props.state.scene,
            nextProps.state.scene
          )
          ;(0, _sceneCreator.updateScene)(
            planData,
            nextProps.state.scene,
            this.props.state.scene,
            changedValues.toJS(),
