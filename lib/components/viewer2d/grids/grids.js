...
function Grids(_ref) {
    ...
    .map(function (_ref2) {
      ...
      switch (grid.type) {
        case 'horizontal-streak':
          return _react2.default.createElement(_gridHorizontalStreak2.default, {
            key: gridID,
            width: width,
            height: height,
            grid: grid,
        ...
        case 'vertical-streak':
          return _react2.default.createElement(_gridVerticalStreak2.default, {
            key: gridID,
            width: width,
            height: height,
            grid: grid,
  ...
  return _react2.default.createElement('g', null, renderedGrids)
}
