...
function Line(_ref) {
  ...
  if (
    ...
    _export.GeometryUtils.samePoints(vertex0, vertex1)
  )
  ...
  var angle = _export.GeometryUtils.angleBetweenTwoPointsAndOrigin(
    x1,
    y1,
    x2,
    y2
  ...
  var renderedRuler = line.selected
    ? _react2.default.createElement(_ruler2.default, {
        unit: scene.unit,
        length: length,
  ...
  return _react2.default.createElement(
    ...
    {
      transform:
        'translate(' + x1 + ', ' + y1 + ') rotate(' + angle + ', 0, 0)',
      'data-element-root': true,
