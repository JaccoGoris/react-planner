  ...
  _createClass(Toolbar, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var alterateColor = alterate
          ? SharedStyle.MATERIAL_COLORS[500].orange
          : ''
        ...
        var sorter = [
          ...
          },
          {
            index: 2,
            condition: allowProjectFileSupport,
            dom: _react2.default.createElement(_toolbarLoadButton2.default, {
              state: state,
            }),
          },
          {
          ...
          },
          {
            ...
            dom: _react2.default.createElement(
              ...
              [
                ...
                ? _react2.default.createElement(Icon2D, {
                    style: { color: alterateColor },
                  })
                : _react2.default.createElement(_fa.FaMousePointer, {
                    style: { color: alterateColor },
                  })
            ),
          },
        ...
        sorter = sorter.concat(
          toolbarButtons.map(function (Component, key) {
            return Component.prototype //if is a react component
              ? {
                  condition: true,
                  dom: _react2.default.createElement(Component, {
                    mode: mode,
                    state: state,
                    key: key,
                  }),
              ...
              : {
                  ...
                  dom: _react2.default.createElement(Component.dom, {
                    mode: mode,
                    state: state,
                    key: key,
                  }),
