    ...
    },
    {
      ...
      value: function render() {
        ...
        if (page !== 'root') {
          ...
          breadcrumbComponent = _react2.default.createElement(
            _catalogBreadcrumb2.default,
        ...
        var turnBackButton =
          pathSize > 0
            ? _react2.default.createElement(_catalogTurnBackPageItem2.default, {
                key: pathSize,
            ...
            this.state.matchString === ''
              ? [
                  ...
                  categoriesToDisplay.map(function (cat) {
                    return _react2.default.createElement(
                      _catalogPageItem2.default,
                      { key: cat.name, page: cat, oldPage: currentCategory }
                    )
                  }),
                  elementsToDisplay.map(function (elem) {
                    return _react2.default.createElement(
                      _catalogItem2.default,
                      { key: elem.name, element: elem }
                    )
                  }),
                ]
              : this.state.matchedElements.map(function (elem) {
                  return _react2.default.createElement(_catalogItem2.default, {
                    key: elem.name,
                    element: elem,
                  })
                })
