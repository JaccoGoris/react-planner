  ...
  _createClass(Item, null, [
    ...
    },
    {
      ...
      value: function select(state, layerID, itemID) {
        ...
        state = _export.Layer.selectElement(state, layerID, 'items', itemID)
          .updatedState
    ...
    },
    {
      ...
      value: function remove(state, layerID, itemID) {
        ...
        state = _export.Layer.removeElement(state, layerID, 'items', itemID)
          .updatedState
    ...
    },
    {
      ...
      value: function unselect(state, layerID, itemID) {
        state = _export.Layer.unselect(state, layerID, 'items', itemID)
          .updatedState
    ...
    },
    {
      ...
      value: function endDrawingItem(state, layerID, x, y) {
        ...
        state = this.updateDrawingItem(state, layerID, x, y, catalog)
          .updatedState
