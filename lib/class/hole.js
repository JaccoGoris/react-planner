  ...
  _createClass(Hole, null, [
    ...
    },
    {
      ...
      value: function select(state, layerID, holeID) {
        ...
        state = _export.Layer.selectElement(state, layerID, 'holes', holeID)
          .updatedState
    ...
    },
    {
      ...
      value: function remove(state, layerID, holeID) {
        ...
        state = _export.Layer.removeElement(state, layerID, 'holes', holeID)
          .updatedState
    ...
    },
    {
      ...
      value: function unselect(state, layerID, holeID) {
        state = _export.Layer.unselect(state, layerID, 'holes', holeID)
          .updatedState
    ...
    },
    {
      ...
      value: function selectToolDrawingHole(state, sceneComponentType) {
        var snapElements = new _immutable.List().withMutations(function (
          snapElements
        ) {
          ...
          lines.forEach(function (line) {
            ...
            ;(0,
            _snap.addLineSegmentSnap)(snapElements, x1, y1, x2, y2, 20, 1, line.id)
          })
        })
    ...
    },
    {
      ...
      value: function updateDrawingHole(state, layerID, x, y) {
        ...
        if (snap) {
          ...
          var alpha = _export2.GeometryUtils.absAngleBetweenTwoPoints(
            x1,
            y1,
            x2,
            y2
          ...
          var cosAlpha = _export2.GeometryUtils.cosWithThreshold(
            alpha,
            0.0000001
          )
          var sinAlpha = _export2.GeometryUtils.sinWithThreshold(
            alpha,
            0.0000001
          )
          ...
          if (x < minLeftVertexHole.x) {
            offset = _export2.GeometryUtils.pointPositionOnLineSegment(
              minVertex.x,
              minVertex.y,
              maxVertex.x,
              maxVertex.y,
    ...
    },
    {
      ...
      value: function beginDraggingHole(state, layerID, holeID, x, y) {
        ...
        var snapElements = (0, _snap.addLineSegmentSnap)(
          (0, _immutable.List)(),
          v0.x,
          v0.y,
          v1.x,
    ...
    },
    {
      ...
      value: function updateDraggingHole(state, x, y) {
        ...
        var lineLength = _export2.GeometryUtils.pointsDistance(
          v0.x,
          v0.y,
          v1.x,
          v1.y
      ...
      value: function setAttributes(state, layerID, holeID, holesAttributes) {
        ...
        state = state
          .mergeIn(
            ...
            (0, _immutable.fromJS)(hAttr)
          )
          .mergeDeepIn(
            ['scene', 'layers', layerID, 'holes', holeID],
            new _immutable.Map({ offset: offset, misc: misc })
          )
