...
var Catalog = (function () {
  function Catalog() {
    ...
    this.registerMultiplePropertyType([
      ['color', _export.PropertyColor, _export.PropertyColor],
      ['enum', _export.PropertyEnum, _export.PropertyEnum],
      ['string', _export.PropertyString, _export.PropertyString],
      ['number', _export.PropertyNumber, _export.PropertyNumber],
      [
        'length-measure',
        _export.PropertyLengthMeasure,
        _export.PropertyLengthMeasure,
      ],
      ['toggle', _export.PropertyToggle, _export.PropertyToggle],
      ['checkbox', _export.PropertyCheckbox, _export.PropertyCheckbox],
      ['hidden', _export.PropertyHidden, _export.PropertyHidden],
      ['read-only', _export.PropertyReadOnly, _export.PropertyReadOnly],
    ])
  }
  ...
  _createClass(Catalog, [
    ...
    },
    {
      ...
      value: function getCategory(categoryName) {
        ...
        throw new Error(
          'Category ' + categoryName + ' does not exist in catalog'
        )
      },
    ...
    },
    {
      ...
      value: function registerMultiplePropertyType(propertyTypeArray) {
        ...
        propertyTypeArray.forEach(function (el) {
          return _this2.registerPropertyType.apply(
            _this2,
            _toConsumableArray(el)
          )
        })
      },
    ...
    },
    {
      ...
      value: function categoryHasElement(categoryName, elementName) {
        return (
          ...
          this.categories[categoryName].elements.some(function (el) {
