...
function PropertyLengthMeasure(_ref, _ref2) {
  ...
  var update = function update(lengthInput, unitInput) {
    ...
    var merged = value.merge({
      length:
        unitInput !== _constants.UNIT_CENTIMETER
          ? (0, _convertUnits2.default)(newLength)
              .from(unitInput)
              .to(_constants.UNIT_CENTIMETER)
          : newLength,
      _length: lengthInput,
      _unit: unitInput,
    })
    ...
    if (hook) {
      return hook(merged, sourceElement, internalState, state).then(function (
        val
      ) {
        return onUpdate(val)
      })
  ...
  return _react2.default.createElement(
    'table',
    {
      ...
      style: _sharedPropertyStyle2.default.tableStyle,
    },
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_export.FormLabel, null, label)
        ),
        _react2.default.createElement(
          'td',
          { style: secondTdStyle },
