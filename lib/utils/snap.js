...
var PointSnap = (function (_Record) {
  ...
  function PointSnap() {
    ...
    return _possibleConstructorReturn(
      this,
      (PointSnap.__proto__ || Object.getPrototypeOf(PointSnap)).apply(
        this,
        arguments
      )
    )
...
var LineSnap = (function (_Record2) {
  ...
  function LineSnap() {
    ...
    return _possibleConstructorReturn(
      this,
      (LineSnap.__proto__ || Object.getPrototypeOf(LineSnap)).apply(
        this,
        arguments
      )
    )
  ...
  _createClass(LineSnap, [
    {
      ...
      value: function nearestPoint(x, y) {
        return _extends(
          ...
          {
            distance: Geometry.distancePointFromLine(
              this.a,
              this.b,
              this.c,
              x,
...
var LineSegmentSnap = (function (_Record3) {
  ...
  function LineSegmentSnap() {
    ...
    return _possibleConstructorReturn(
      this,
      (
        LineSegmentSnap.__proto__ || Object.getPrototypeOf(LineSegmentSnap)
...
var GridSnap = (function (_Record4) {
  ...
  function GridSnap() {
    ...
    return _possibleConstructorReturn(
      this,
      (GridSnap.__proto__ || Object.getPrototypeOf(GridSnap)).apply(
        this,
        arguments
      )
    )
...
function addLineSnap(snapElements, a, b, c, radius, priority, related) {
  ...
  return snapElements.withMutations(function (snapElements) {
    ...
    var intersections = snapElements
      .valueSeq()
