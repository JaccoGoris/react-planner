...
exports.default = function (state, action) {
  switch (action.type) {
    ...
    case _constants.CHANGE_CATALOG_PAGE:
      return _export2.Project.changeCatalogPage(
        state,
        action.oldPage,
        action.newPage
      ).updatedState
    ...
    case _constants.GO_BACK_TO_CATALOG_PAGE:
      return _export2.Project.goBackToCatalogPage(state, action.newPage)
        .updatedState
    ...
    case _constants.SET_PROPERTIES:
      state = state.merge({
        sceneHistory: _export.history.historyPush(
          state.sceneHistory,
          state.scene
        ),
      })
      return _export2.Project.setProperties(
        state,
    ...
    case _constants.SET_ITEMS_ATTRIBUTES:
      ...
      return _export2.Project.setItemsAttributes(state, action.itemsAttributes)
        .updatedState
    ...
    case _constants.SET_LINES_ATTRIBUTES:
      ...
      return _export2.Project.setLinesAttributes(state, action.linesAttributes)
        .updatedState
    ...
    case _constants.SET_HOLES_ATTRIBUTES:
      ...
      return _export2.Project.setHolesAttributes(state, action.holesAttributes)
        .updatedState
    ...
    case _constants.SET_PROJECT_PROPERTIES:
      ...
      return _export2.Project.setProjectProperties(state, action.properties)
        .updatedState
    ...
    case _constants.UPDATE_MOUSE_COORDS:
      return _export2.Project.updateMouseCoord(state, action.coords)
        .updatedState
    ...
    case _constants.COPY_PROPERTIES:
      return _export2.Project.copyProperties(state, action.properties)
        .updatedState
    ...
    case _constants.PUSH_LAST_SELECTED_CATALOG_ELEMENT_TO_HISTORY:
      return _export2.Project.pushLastSelectedCatalogElementToHistory(
        state,
        action.element
      ).updatedState
    ...
    case _constants.ADD_HORIZONTAL_GUIDE:
      ...
      return _export2.Project.addHorizontalGuide(state, action.coordinate)
        .updatedState

    case _constants.ADD_VERTICAL_GUIDE:
      return _export2.Project.addVerticalGuide(state, action.coordinate)
        .updatedState

    case _constants.ADD_CIRCULAR_GUIDE:
      return _export2.Project.addCircularGuide(
        state,
        action.x,
        action.y,
        action.radius
    ...
    case _constants.REMOVE_HORIZONTAL_GUIDE:
      return _export2.Project.removeHorizontalGuide(state, action.guideID)
        .updatedState

    case _constants.REMOVE_VERTICAL_GUIDE:
      return _export2.Project.removeVerticalGuide(state, action.guideID)
        .updatedState

    case _constants.REMOVE_CIRCULAR_GUIDE:
      return _export2.Project.removeCircularGuide(state, action.guideID)
        .updatedState
