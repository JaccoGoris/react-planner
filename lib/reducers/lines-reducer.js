...
exports.default = function (state, action) {
  switch (action.type) {
    case _constants.SELECT_TOOL_DRAWING_LINE:
      return _export.Line.selectToolDrawingLine(
        state,
    ...
    case _constants.BEGIN_DRAWING_LINE:
      ...
      return _export.Line.beginDrawingLine(
        state,
        action.layerID,
        action.x,
        action.y
    ...
    case _constants.UPDATE_DRAWING_LINE:
      return _export.Line.updateDrawingLine(state, action.x, action.y)
        .updatedState
    ...
    case _constants.BEGIN_DRAGGING_LINE:
      ...
      return _export.Line.beginDraggingLine(
        state,
        action.layerID,
        action.lineID,
        action.x,
    ...
    case _constants.UPDATE_DRAGGING_LINE:
      return _export.Line.updateDraggingLine(state, action.x, action.y)
        .updatedState
    ...
    case _constants.END_DRAGGING_LINE:
      ...
      return _export.Line.endDraggingLine(state, action.x, action.y)
        .updatedState

    case _constants.SELECT_LINE:
      return _export.Line.select(state, action.layerID, action.lineID)
        .updatedState
