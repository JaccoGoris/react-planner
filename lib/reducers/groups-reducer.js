...
exports.default = function (state, action) {
  ...
  switch (action.type) {
    ...
    case _constants.GROUP_ACTIONS.ADD_TO_GROUP:
      return _export.Group.addElement(
        state,
        action.groupID,
        action.layerID,
    ...
    case _constants.GROUP_ACTIONS.REMOVE_FROM_GROUP:
      return _export.Group.removeElement(
        state,
        action.groupID,
        action.layerID,
        action.elementPrototype,
    ...
    case _constants.GROUP_ACTIONS.SET_GROUP_ATTRIBUTES:
      return _export.Group.setAttributes(
        state,
        action.groupID,
        action.attributes
      ).updatedState
    ...
    case _constants.GROUP_ACTIONS.SET_GROUP_PROPERTIES:
      return _export.Group.setProperties(
        state,
        action.groupID,
        action.properties
      ).updatedState
    ...
    case _constants.GROUP_ACTIONS.SET_GROUP_BARYCENTER:
      return _export.Group.setBarycenter(
        state,
        action.groupID,
    ...
    case _constants.GROUP_ACTIONS.REMOVE_GROUP_AND_DELETE_ELEMENTS:
      return _export.Group.removeAndDeleteElements(state, action.groupID)
        .updatedState

    case _constants.GROUP_ACTIONS.GROUP_TRANSLATE:
      return _export.Group.translate(state, action.groupID, action.x, action.y)
        .updatedState

    case _constants.GROUP_ACTIONS.GROUP_ROTATE:
      return _export.Group.rotate(state, action.groupID, action.rotation)
        .updatedState
