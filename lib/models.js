...
var safeLoadMapList = function safeLoadMapList(mapList, Model, defaultMap) {
  return mapList
    ? new _immutable.Map(mapList)
        .map(function (m) {
          return new Model(m)
        })
        .toMap()
    : defaultMap || new _immutable.Map()
}
...
var Grid = (exports.Grid = (function (_Record) {
  ...
  function Grid() {
    ...
    return _possibleConstructorReturn(
      this,
      (Grid.__proto__ || Object.getPrototypeOf(Grid)).call(
        this,
        _extends({}, json, {
...
var ElementsSet = (exports.ElementsSet = (function (_Record2) {
  ...
  function ElementsSet() {
    ...
    return _possibleConstructorReturn(
      this,
      (ElementsSet.__proto__ || Object.getPrototypeOf(ElementsSet)).call(this, {
...
var Vertex = (exports.Vertex = (function (_Record3) {
  ...
  function Vertex() {
    ...
    return _possibleConstructorReturn(
      this,
      (Vertex.__proto__ || Object.getPrototypeOf(Vertex)).call(
        this,
        _extends({}, json, {
          lines: new _immutable.List(json.lines || []),
          areas: new _immutable.List(json.areas || []),
...
var Hole = (exports.Hole = (function (_Record5) {
  ...
  function Hole() {
    ...
    return _possibleConstructorReturn(
      this,
      (Hole.__proto__ || Object.getPrototypeOf(Hole)).call(
        this,
        _extends({}, json, {
          properties: (0, _immutable.fromJS)(json.properties || {}),
        })
...
var Area = (exports.Area = (function (_Record6) {
  ...
  function Area() {
    ...
    return _possibleConstructorReturn(
      this,
      (Area.__proto__ || Object.getPrototypeOf(Area)).call(
        this,
        _extends({}, json, {
          properties: (0, _immutable.fromJS)(json.properties || {}),
          vertices: new _immutable.List(json.vertices || []),
...
var Item = (exports.Item = (function (_Record7) {
  ...
  function Item() {
    ...
    return _possibleConstructorReturn(
      this,
      (Item.__proto__ || Object.getPrototypeOf(Item)).call(
        this,
        _extends({}, json, {
          properties: (0, _immutable.fromJS)(json.properties || {}),
        })
...
var Layer = (exports.Layer = (function (_Record8) {
  ...
  function Layer() {
    ...
    return _possibleConstructorReturn(
      this,
      (Layer.__proto__ || Object.getPrototypeOf(Layer)).call(
        this,
        _extends({}, json, {
...
var Group = (exports.Group = (function (_Record9) {
  ...
  function Group() {
    ...
    return _possibleConstructorReturn(
      this,
      (Group.__proto__ || Object.getPrototypeOf(Group)).call(
        this,
        _extends({}, json, {
          properties: (0, _immutable.fromJS)(json.properties || {}),
...
var Scene = (exports.Scene = (function (_Record10) {
  ...
  function Scene() {
    ...
    return _possibleConstructorReturn(
      this,
      (Scene.__proto__ || Object.getPrototypeOf(Scene)).call(
        this,
        _extends({}, json, {
          ...
          meta: json.meta
            ? (0, _immutable.fromJS)(json.meta)
            : new _immutable.Map(),
          guides: json.guides
            ? (0, _immutable.fromJS)(json.guides)
            : new _immutable.Map({
...
var CatalogElement = (exports.CatalogElement = (function (_Record11) {
  ...
  function CatalogElement() {
    ...
    return _possibleConstructorReturn(
      this,
      (CatalogElement.__proto__ || Object.getPrototypeOf(CatalogElement)).call(
        this,
        _extends({}, json, {
...
var Catalog = (exports.Catalog = (function (_Record12) {
  ...
  function Catalog() {
    ...
    return _possibleConstructorReturn(
      this,
      (Catalog.__proto__ || Object.getPrototypeOf(Catalog)).call(this, {
        elements: elements,
  ...
  _createClass(Catalog, [
    {
      ...
      value: function factoryElement(type, options, initialProperties) {
        ...
        var properties = element.properties.map(function (value, key) {
          return initialProperties && initialProperties.has(key)
...
var HistoryStructure = (exports.HistoryStructure = (function (_Record13) {
  ...
  function HistoryStructure() {
    ...
    return _possibleConstructorReturn(
      this,
      (
        HistoryStructure.__proto__ || Object.getPrototypeOf(HistoryStructure)
      ).call(this, {
...
var State = (exports.State = (function (_Record14) {
  ...
  function State() {
    ...
    return _possibleConstructorReturn(
      this,
      (State.__proto__ || Object.getPrototypeOf(State)).call(
        this,
        _extends({}, json, {
