      ...
      switch (event.keyCode) {
        ...
        case _constants.KEYBOARD_BUTTON_CODE.DELETE: {
          if (
            ...
            store.dispatch((0, _projectActions.remove)())
          break
        }
        ...
        case _constants.KEYBOARD_BUTTON_CODE.Z: {
          if (
            ...
            store.dispatch((0, _projectActions.undo)())
          break
        }
        case _constants.KEYBOARD_BUTTON_CODE.ALT: {
          if (_constants.MODE_SNAPPING.includes(mode))
            store.dispatch(
              (0, _projectActions.toggleSnap)(
        ...
        case _constants.KEYBOARD_BUTTON_CODE.C: {
          ...
          if (
            ...
            if (selected.holes.size) {
              ...
              store.dispatch(
                (0, _projectActions.copyProperties)(hole.get('properties'))
              )
            } else if (selected.areas.size) {
              var area = state.getIn([
                'scene',
                'layers',
                selectedLayer,
                'areas',
              ...
              store.dispatch(
                (0, _projectActions.copyProperties)(area.properties)
              )
              ...
              store.dispatch(
                (0, _projectActions.copyProperties)(item.properties)
              )
              ...
              store.dispatch(
                (0, _projectActions.copyProperties)(line.properties)
              )
            }
          }
          break
